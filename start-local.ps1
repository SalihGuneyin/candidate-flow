...
if ($backendListener) {
    ...
    if ($backendCommandLine -and $backendCommandLine.Contains('com.salihguneyin.candidateflow.CandidateFlowApplication')) {
...
if ($frontendListener) {
    ...
    if ($frontendCommandLine -and $frontendCommandLine.ToLowerInvariant().Contains('candidate-flow')) {
